defmodule Zoth.Plug do
  @moduledoc """
  Zoth.Plug contains functions that assist with interacting with
  Zoth via Plugs.

  Zoth.Plug is not itself a plug.

  Use the helpers to look up current_access_token and current_resource_owner.

  ## Example
      Zoth.Plug.current_access_token(conn)
      Zoth.Plug.current_resource_owner(conn)
  """

  alias Zoth.{Keys, AccessTokens.AccessToken}
  alias Plug.Conn
