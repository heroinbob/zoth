defmodule Zoth.Token.Revoke do
  @moduledoc """
  ...
  Zoth does not use the token_type_hint logic described in the
  ...
  #
  # Zoth determines the client type implicitly via the presence of the
