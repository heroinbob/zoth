defmodule Zoth.AccessTokens do
  @moduledoc """
  Ecto schema for oauth access tokens
  """

  import Ecto.Query
  alias Zoth.Mixin.{Expirable, Revocable, Scopes}
  alias Zoth.{AccessTokens.AccessToken, Applications.Application, Config}
  alias Zoth.Scopes, as: ScopesUtils
  alias Zoth.Schema, as: SchemaHelpers
