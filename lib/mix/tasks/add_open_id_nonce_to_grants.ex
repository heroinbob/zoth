defmodule Mix.Tasks.Zoth.AddOpenIdNonceToGrants do
  ...
  Generates a migration file that adds open_id_nonce to the access grants table.
      ...
      mix zoth.add_open_id_nonce_to_grants -r MyApp.Repo

      # Update your custom table name if you used another one
      mix zoth.add_open_id_nonce_to_grants -r MyApp.Repo --table some_other_name
  ...
  @mix_task "zoth.add_open_id_nonce_to_grants"
