defmodule Mix.Tasks.Zoth.Gen.Migration do
  @shortdoc "Generates Zoth migration file"

  @moduledoc """
  Generates migration file.

      mix zoth.gen.migrations -r MyApp.Repo

      mix zoth.gen.migrations -r MyApp.Repo --namespace oauth2
  ...
  alias Mix.{Ecto, Zoth, Zoth.Migration}
