defmodule Zoth.Plug.EnsureScopes do
  ...
  ### Example
     ...
     If the handler option is not passed, `Zoth.Plug.ErrorHandler`
  ...
  defp handle_error({:error, %Conn{params: params} = conn, opts}) do
    ...
    conn
    |> Conn.assign(:zoth_failure, :unauthorized)
    |> Conn.halt()
