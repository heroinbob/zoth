defmodule Zoth.Authorization.DeviceCode do
  @moduledoc """
  ...
  """
  alias Ecto.Schema
  alias Zoth.Authorization.DeviceCode.DeviceAuthorization
  alias Zoth.Authorization.DeviceCode.UserInteraction
  alias Zoth.Authorization.Utils.Response
